...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, port, apiVersion, app, swagger, document;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = env_constant_1.ENV_CONFIG.system, port = _a.port, apiVersion = _a.apiVersion;
                ...
                case 2:
                    _b.sent();
                    common_1.Logger.log("Server listening on http://localhost:".concat(port, "/"));
                    return [2 /*return*/];
            }
        });
    });
